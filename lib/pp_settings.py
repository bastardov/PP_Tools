...
DEFAULT_SETTINGS = {
    ...
    # «Разместить на листы»: поля рамки (слева, справа, сверху, снизу со
    # штампом, мм), суффикс номера, пробовать ли книжную ориентацию и
    # id последнего листа-образца. Заполняется окном инструмента.
    "sheet_place_settings": {}
}
